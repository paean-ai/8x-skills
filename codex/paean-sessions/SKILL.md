---
name: paean-sessions
description: Prepare, privately upload, review and explicitly share session JSONL with Paean for credits, or withdraw a contribution. Use for session Assets and Clide creation evidence; uploading does not publish an app or prove original authorship.
---

# Paean Sessions (Codex)
...
> *"For this task, follow `8x-skills/codex/paean-sessions/SKILL.md`."*, or point Codex at
